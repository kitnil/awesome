...
- [one-line-wonders](https://github.com/wzhouwzhou/one-line-wonders) - OneLineWondersCode | An actively maintained collection of "one-line" programs in various languages, performing various tasks | 234/250 One-Line Programs Milestone!
...
- [xray-16](https://github.com/OpenXRay/xray-16) - Improved version of the X-Ray engine, used in world famous S.T.A.L.K.E.R. game series by GSC Game World.
...
- [glChAoS.P](https://github.com/BrutPitt/glChAoS.P) - Real time 3D strange attractors scout and hypercomplex fractals - over 200 Million particles
...
- [gzdoom](https://github.com/coelckers/gzdoom) - GZDoom adds an OpenGL renderer to the ZDoom source port.
...
- [gnucap](https://github.com/gnucap/gnucap) - gnucap mirror, defunct, moved to codeberg.org/gnucap
...
- [Hypersomnia](https://github.com/TeamHypersomnia/Hypersomnia) - Multiplayer top-down shooter released as free software.
...
- [sayid](https://github.com/clojure-emacs/sayid) - A debugger for Clojure
- [hugit](https://github.com/hugit-project/hugit) - The humane Terminal UI for git!
...
- [hubot-auth](https://github.com/hubot-scripts/hubot-auth) - Assign roles to users and restrict command access in other scripts
...
- [cl-bodge](https://github.com/borodust/cl-bodge) - Feature-rich game framework for Common Lisp
...
- [numcl](https://github.com/numcl/numcl) - Numpy clone in Common Lisp
- [cl-project](https://github.com/fukamachi/cl-project) - Generate modern project skeletons
- [cl-lemma](https://github.com/t-cool/cl-lemma) - English lemmatizer in Common Lisp
- [queen.lisp](https://github.com/mishoo/queen.lisp) - Chess utilities for Common Lisp
- [bit-smasher](https://github.com/thephoeron/bit-smasher) - Common Lisp library for handling bit vectors, bit vector arithmetic, and type conversions.
- [croatoan](https://github.com/McParen/croatoan) - Common Lisp bindings for the ncurses terminal library.
- [cl-pong-game](https://github.com/eliasfeijo/cl-pong-game) - A simple Pong game made for Lisp Game Jam 2019, using trivial-gamekit library
- [Petalisp](https://github.com/marcoheisig/Petalisp) - Elegant High Performance Computing
- [cl-wiringpi2](https://github.com/TeMPOraL/cl-wiringpi2) - CFFI bindings to WiringPi 2 for Common Lisp.
- [sbcli](https://github.com/hellerve/sbcli) - A REPL for my SBCL needs
- [auto-text](https://github.com/defunkydrummer/auto-text) - Automatic  (encoding, end of line, column width, etc) detection for text files. 100% Common Lisp.
- [cl-ppcre](https://github.com/edicl/cl-ppcre) - Common Lisp regular expression library
- [carteiro](https://github.com/parjanya/carteiro) - A system for querying the brazilian post office   tracking system.
- [cl-react](https://github.com/helmutkian/cl-react) - Common Lisp (Parenscript) utilities for building web apps in ReactJs
- [mexpr](https://github.com/tmccombs/mexpr) - Macro for Common Lisp to allow infix syntax for mathematicall expressions.
- [shipshape](https://github.com/cbaggers/shipshape) - A system to help ship lisp code with C dependencies
- [qlot](https://github.com/fukamachi/qlot) - A project-local library installer for Common Lisp
- [lisp-critic](https://github.com/g000001/lisp-critic) - The Lisp Critic scans your code for instances of bad Lisp programming practice.
- [trivial-gamekit-template](https://github.com/RyanBurnside/trivial-gamekit-template) - A small template designed as a quickstart for trivial gamekit projects.
- [nature-of-code](https://github.com/mark-gerarts/nature-of-code) - Nature of code exercises and examples implemented in Common Lisp
...
- [cl-wayland](https://github.com/malcolmstill/cl-wayland) - Common Lisp bindings for libwayland
...
- [the-invaders](https://github.com/sebity/the-invaders) - A remake of the classic game Space Invaders
- [trivial-gamekit](https://github.com/borodust/trivial-gamekit) - Simple framework for making 2D games
...
- [oclcl](https://github.com/gos-k/oclcl) - S-expression to OpenCL C
- [cl-yaclyaml](https://github.com/mabragor/cl-yaclyaml) - Yet Another Common Lisp YaML processor
- [cl-yaml](https://github.com/eudoxia0/cl-yaml) - YAML parser for Common Lisp
...
- [cepl-youtube-examples](https://github.com/stacksmith/cepl-youtube-examples) - Updated code and descriptions for cbaggers cepl videos (stalled)
...
- [vgstation13](https://github.com/vgstation-coders/vgstation13) - Butts
...
- [docker-bitlbee](https://github.com/mbologna/docker-bitlbee) - Dockerfile to create a Docker container for bitlbee
...
- [ex_cli](https://github.com/danhper/ex_cli) - User friendly CLI apps for Elixir
...
- [emacs-ccls](https://github.com/MaskRay/emacs-ccls) - Emacs client for ccls, a C/C++ language server
- [emacs-cquery](https://github.com/cquery-project/emacs-cquery) - Emacs client for cquery, a low-latency language server supporting multi-million line C++ code-bases
- [xcscope.el](https://github.com/dkogan/xcscope.el) - cscope interface for (X)Emacs
...
- [emacs-package-checker](https://github.com/akirak/emacs-package-checker) - Check Emacs Lisp packages in a clean environment
...
- [emacs-taskrunner](https://github.com/emacs-taskrunner/emacs-taskrunner) - A universal task runner for emacs
- [stock-tracker](https://github.com/beacoder/stock-tracker) - Track stock price in Emacs
- [reaper](https://github.com/xendk/reaper) - Harvest client for Emacs
- [emacs-howdoyou](https://github.com/thanhvg/emacs-howdoyou) - Search and read stackoverflow and its sisters’ sites
- [helm-fuzzy](https://github.com/elpa-host/helm-fuzzy) - Fuzzy matching for helm source.
- [emacs-balanced-windows](https://github.com/wbolster/emacs-balanced-windows) - emacs minor mode to automatically keep windows balanced
- [asx](https://github.com/ragone/asx) - Ask StackExchange in Emacs
- [annalist.el](https://github.com/noctuid/annalist.el) - Record and display information such as keybindings
- [scrot.el](https://github.com/dakra/scrot.el) - Emacs screenshot utility using scrot
- [lozenge.el](https://github.com/Kungsgeten/lozenge.el) - Pollen inspired lozenge syntax for Emacs
- [shortcuts.el](https://github.com/tetron/shortcuts.el) - Shortcut bar for Emacs
- [statusbar.el](https://github.com/dakra/statusbar.el) - Emacs statusbar over the minibuffer with child frames
- [gorepl-mode](https://github.com/manute/gorepl-mode) - A minor emacs mode for Go REPL
- [org-tanglesync.el](https://github.com/mtekman/org-tanglesync.el) - A package to pull external changes into an org-mode source block if that block is tangled to an external file
- [propcheck](https://github.com/Wilfred/propcheck) - Quickcheck/hypothesis style testing for elisp
- [emacs-hide-mode-line](https://github.com/hlissner/emacs-hide-mode-line) - An Emacs plugin that hides (or masks) the current buffer's mode-line
...
- [ssh-config-mode-el](https://github.com/jhgorrell/ssh-config-mode-el) - emacs mode for editing ssh config files.
- [terraform-doc](https://github.com/TxGVNN/terraform-doc) - terraform-doc for GNU Emacs
- [emacs-python-black](https://github.com/wbolster/emacs-python-black) - Emacs package to reformat Python using black-macchiato
- [mark-thing-at](https://github.com/plandes/mark-thing-at) - Mark a pattern at the current point.
- [company-fuzzy](https://github.com/elpa-host/company-fuzzy) - Fuzzy matching for `company-mode'.
- [edwina](https://github.com/ajgrf/edwina) - Dynamic window manager for Emacs
- [grip-mode](https://github.com/seagle0128/grip-mode) - Instant Github-flavored Markdown/Org preview using grip
- [galactic-emacs](https://github.com/daviderestivo/galactic-emacs) - A Emacs distribution coming from the space ...
- [ellocate](https://github.com/walseb/ellocate) - A more flexible locate implemented in Emacs Lisp
- [overseer.el](https://github.com/tonini/overseer.el) - Ert-runner Integration Into Emacs
- [indicators.el](https://github.com/Fuco1/indicators.el) - Display the buffer relative location of line in the fringe.
...
- [mpv.el](https://github.com/kljohann/mpv.el) - control mpv for easy note taking
- [ranger.el](https://github.com/ralesi/ranger.el) - Bringing the goodness of ranger to dired!
- [fast-scroll](https://github.com/ahungry/fast-scroll) - Emacs package to ensure scrolling remains fast
- [prism.el](https://github.com/alphapapa/prism.el) - Disperse Lisp forms (and other languages) into a spectrum of colors by depth
- [ivy-clojuredocs](https://github.com/wandersoncferreira/ivy-clojuredocs) - Searching for help in ClojureDocs.org
...
- [jeison](https://github.com/SavchenkoValeriy/jeison) - An Emacs library for declarative JSON parsing
- [convention](https://github.com/chiply/convention) - An emacs package for interacting with any programming language, no local interpreters or compilers required
...
- [org-shoplist](https://github.com/lordnik22/org-shoplist) - An extension for creating shoping lists and eating plans in org-mode
- [centaur-tabs](https://github.com/ema2159/centaur-tabs) - Emacs plugin aiming to become an aesthetic, modern looking tabs plugin
- [java-one-click-run](https://github.com/MatthewZMD/java-one-click-run) - Compile and run Java programs easily within Emacs
- [arm-mode](https://github.com/charJe/arm-mode) - Emacs major mode for editing Advanced RISC machine files
- [clean-aindent-mode](https://github.com/pmarinov/clean-aindent-mode) - Emacs extension for simple indent and unindent
- [persistent-soft](https://github.com/rolandwalker/persistent-soft) - Persistent storage for Emacs, returning nil on failure
- [bic](https://github.com/legoscia/bic) - Best IMAP Client (for Emacs)
- [jsonl.el](https://github.com/ebpa/jsonl.el) - Utility functions for working with line-delimited JSON ("JSON Lines")
- [subed](https://github.com/rndusr/subed) - Subtitle editor for Emacs
- [emacs-helm-esa](https://github.com/masutaka/emacs-helm-esa) - esa with helm interface (\( ⁰⊖⁰)/)
- [lolcat.el](https://github.com/xuchunyang/lolcat.el) - Rainbows and unicorns in Emacs Lisp!
- [deadgrep](https://github.com/Wilfred/deadgrep) - fast, friendly searching with ripgrep and Emacs
- [org-yt](https://github.com/TobiasZawada/org-yt) - Youtube links in org-mode, see  https://emacs.stackexchange.com/questions/38098/org-mode-custom-youtube-link-syntax
- [defrepeater.el](https://github.com/alphapapa/defrepeater.el) - Easily define repeatable Emacs commands
- [eshell-fixed-prompt-mode](https://github.com/mallt/eshell-fixed-prompt-mode) - Emacs minor mode to restrict eshell to a single fixed prompt
- [org-clock-today-mode](https://github.com/mallt/org-clock-today-mode) - Emacs minor mode to show the total clocked time of the current day in the mode line
- [cmd-to-echo](https://github.com/mallt/cmd-to-echo) - Show the output of long-running commands in the emacs echo area
- [mysql-to-org-mode](https://github.com/mallt/mysql-to-org-mode) - Minor mode for emacs to output the results of mysql queries to org tables
- [format-table](https://github.com/functionreturnfunction/format-table) - Parse and reformat tabular data in emacs.
- [helm-suggest](https://github.com/xuchunyang/helm-suggest) - Web suggest (autocomplete) with helm
- [xtest](https://github.com/promethial/xtest) - Simple Testing With Emacs & ERT
- [mu4e-alert](https://github.com/iqbalansari/mu4e-alert) - Desktop notifications and modeline display for mu4e
- [javadoc-lookup](https://github.com/skeeto/javadoc-lookup) - Quickly lookup Javadoc pages from Emacs
- [rfc-mode](https://github.com/galdor/rfc-mode) - An Emacs major mode to read and browse RFC documents.
...
- [show-eol](https://github.com/elpa-host/show-eol) - Show end of line symbol in buffer.
- [backup-each-save](https://github.com/conornash/backup-each-save) - Emacs package to backup each save of a file
- [cli-docs.el](https://github.com/xuchunyang/cli-docs.el) - 
- [emacs-chat](https://github.com/h1t/emacs-chat) - emacs wrapper for pidgin instant messager
- [emms-bilibili](https://github.com/stardiviner/emms-bilibili) - Bilibili playlist for EMMS
...
- [ob-restclient.el](https://github.com/alf/ob-restclient.el) - An org-mode extension to restclient.el
- [json-navigator](https://github.com/DamienCassou/json-navigator) - View and navigate JSON structures
- [gpastel](https://github.com/DamienCassou/gpastel) - Integrates the GPaste clipboard manager and Emacs' kill-ring
- [find-define](https://github.com/manateelazycat/find-define) - Jump to the definition of a function or variable
...
- [zone-matrix-wake-up](https://github.com/vreeze/zone-matrix-wake-up) - The Matrix wake up scene as an Emacs zone/screen saver
- [emacs-counsel-tramp](https://github.com/masasam/emacs-counsel-tramp) - Tramp ivy interface for ssh and docker and ‎vagrant
- [flymake-eslint](https://github.com/orzechowskid/flymake-eslint) - Flymake backend for Javascript using eslint
- [gopher.el](https://github.com/msnyder-info/gopher.el) - a gopher interface for emacs
- [graphql-mode](https://github.com/davazp/graphql-mode) - An Emacs mode for GraphQL
- [gitlab-snippet.el](https://github.com/travitch/gitlab-snippet.el) - An emacs package for posting snippets of code to a gitlab instance
- [countdown.el](https://github.com/xuchunyang/countdown.el) - 10 9 8 7 6 5...
- [fill-function-arguments](https://github.com/davidshepherd7/fill-function-arguments) - An emacs package to add/remove line breaks between function arguments and similar constructs
- [better-jumper](https://github.com/gilbertw1/better-jumper) - A configurable jump list implementation for Emacs
- [touchgrid.el](https://github.com/larsmagne/touchgrid.el) - Control Emacs by reading libinput events
- [isearch-project](https://github.com/elpa-host/isearch-project) - Incremental search through the whole project.
- [lsp-treemacs](https://github.com/emacs-lsp/lsp-treemacs) - lsp-mode :heart: treemacs
- [magit-lfs](https://github.com/Ailrun/magit-lfs) - Git LFS for magit!
- [magit-tbdiff](https://github.com/magit/magit-tbdiff) - Magit extension for git-tbdiff and git-range-diff
- [org-reverse-datetree](https://github.com/akirak/org-reverse-datetree) - Reversed date trees for Emacs Org mode
- [org-static-blog](https://github.com/bastibe/org-static-blog) - A static site generator using org-mode
- [pfuture](https://github.com/Alexander-Miller/pfuture) - 
- [poly-org](https://github.com/polymode/poly-org) - Polymode for org-mode
...
- [elpher](https://github.com/tgvaughan/elpher) - A friendly Gopher client in Emacs Lisp.
...
- [ros](https://github.com/LionyxML/ros) - screenshot / paste tool for org-mode files
- [transient](https://github.com/magit/transient) - Transient commands
- [point-history](https://github.com/blue0513/point-history) - Show the history of points you visited before
- [slime-repl-ansi-color](https://github.com/emacsmirror/slime-repl-ansi-color) - Turn on ANSI colors in REPL output;
- [awesome-tray](https://github.com/manateelazycat/awesome-tray) - Hide mode-line, display necessary information at right of minibuffer.
- [ox-clip](https://github.com/jkitchin/ox-clip) - Copy formatted content from org-mode
- [ejacs](https://github.com/emacsattic/ejacs) - 
...
- [frog-jump-buffer](https://github.com/waymondo/frog-jump-buffer) - The fastest buffer-jumping Emacs lisp package around
- [bookmark-plus](https://github.com/emacsmirror/bookmark-plus) - Bookmark+: extensions to standard library `bookmark.el'
- [zop-to-char](https://github.com/thierryvolpiatto/zop-to-char) - A visual zap-to-char command for emacs
...
- [markdown-bullets](https://github.com/xuchunyang/markdown-bullets) - Markdown port of org-bullets
- [ox-slack](https://github.com/xuchunyang/ox-slack) - Slack export backend for Eamcs org-mode
- [file-mime-type.el](https://github.com/xuchunyang/file-mime-type.el) - Get file's mime type via file(1)
- [region-state.el](https://github.com/xuchunyang/region-state.el) - Show the number of chars/lines or rows/columns in the region
- [semaphore.el](https://github.com/webnf/semaphore.el) - 
- [github-stars.el](https://github.com/xuchunyang/github-stars.el) - An Emacs Package for browsing your Github Stars
- [buffer-expose](https://github.com/clemera/buffer-expose) - Visual buffer switching in Emacs using a window grid
- [cds-mode](https://github.com/dakra/cds-mode) - Emacs major mode for editing Core Data Services (CDS) files
- [inf-mongo](https://github.com/endofunky/inf-mongo) - Inferior MongoDB mode for Emacs.
- [magit-gerrit](https://github.com/darcylee/magit-gerrit) - Magit plugin for Gerrit Code Review
- [magit-gerrit2](https://github.com/pangwa/magit-gerrit2) - Magit plugin for Gerrit Code Review
- [link-hint.el](https://github.com/noctuid/link-hint.el) - Pentadactyl-like Link Hinting in Emacs with Avy
- [gnome-night-light.el](https://github.com/sham1/gnome-night-light.el) - 
- [unkillable-scratch](https://github.com/EricCrosson/unkillable-scratch) - Disallow the *scratch* buffer from being killed
- [gnus-summary-repo](https://github.com/TxGVNN/gnus-summary-repo) - Import and export files between IMAP and local by using GNUS
- [notate](https://github.com/ekaschalk/notate) - Program with Personal Notation
- [org-kindle](https://github.com/stardiviner/org-kindle) - Make Emacs bridge between Org Mode and Kindle.
...
- [ample-regexps.el](https://github.com/immerrr/ample-regexps.el) - Compose and reuse Emacs regular expressions with ease
- [emacs-aio](https://github.com/skeeto/emacs-aio) - async/await for Emacs Lisp
...
- [dired-git-info](https://github.com/clemera/dired-git-info) - Show git info in Emacs dired
...
- [xr](https://github.com/mattiase/xr) - Inverse of rx: convert Emacs string regexps to rx form
...
- [recently-el](https://github.com/10sr/recently-el) - Recently Opened Files
- [awesome-pair](https://github.com/manateelazycat/awesome-pair) - Auto parenthesis pairing with syntax table
...
- [esonify](https://github.com/oflatt/esonify) - An emacs extension that sonifies your code.
- [clipboard-collector](https://github.com/clemera/clipboard-collector) - Collect clipboard entries according to regex rules in Emacs.
...
- [godoctor](https://github.com/emacsmirror/godoctor) - Frontend for godoctor
- [lsp-java](https://github.com/emacs-lsp/lsp-java) - lsp-mode :heart: java
...
- [rust-auto-use.el](https://github.com/vmalloc/rust-auto-use.el) - Emacs Lisp Package for Auto-Inserting Rust "use" Statements
- [gtm-emacs-plugin](https://github.com/c301/gtm-emacs-plugin) - Plugin for the Emacs editor to be used with the Git Time Metric platform.
- [gnus-recent](https://github.com/unhammer/gnus-recent) - Avoid having to open Gnus and find the right group just to get back to that e-mail you were reading.
- [poly-ansible](https://github.com/emacsmirror/poly-ansible) - Polymode for Ansible: Jinja2 in YAML
- [forth-mode](https://github.com/larsbrinkhoff/forth-mode) - Wants to be the SLIME of Forth
- [ob-tmux](https://github.com/ahendriksen/ob-tmux) - Ob-tmux is an Emacs library that allows org mode to evaluate code blocks in a tmux session.
- [prettier.el](https://github.com/jscheid/prettier.el) - Prettier code formatting for Emacs.
- [zones](https://github.com/emacsmirror/zones) - Zones of text - like multiple regions
...
- [metamorph](https://github.com/AdamNiederer/metamorph) - Transform your code in turing-complete ways
- [barhop](https://github.com/tautologyclub/barhop) - Experimental fast-jumping speedbar for projectile
...
- [slow-keys](https://github.com/manuel-uberti/slow-keys) - Emacs minor mode to avoid RSI
...
- [psysh.el](https://github.com/emacs-php/psysh.el) - PsySH on Emacs, PHP interactive shell (REPL)
- [apache-mode](https://github.com/emacs-php/apache-mode) - Major mode for editing Apache configuration files
- [b.el](https://github.com/emacs-php/b.el) - Emacs Lisp utility functions for buffer manipulation
...
- [build-farm.el](https://github.com/alezost/build-farm.el) - Interface for Hydra and Cuirass (Nix and Guix build farms)
- [semantic-php](https://github.com/jorissteyn/semantic-php) - Modern PHP language support for Semantic.
- [go-projectile](https://github.com/dougm/go-projectile) - Go language related add-ons for Projectile
- [color-file](https://github.com/jmercouris/color-file) - Color files in the minibuffer based on mode and file extension.
- [all-the-icons-ivy](https://github.com/asok/all-the-icons-ivy) - all-the-icons.el for Ivy/Counsel
...
- [use-ttf](https://github.com/elpa-host/use-ttf) - Keep font consistency across different OSs.
...
- [djangonaut](https://github.com/pythonic-emacs/djangonaut) - Emacs minor mode for Django.
...
- [lsp-php](https://github.com/emacs-lsp-legacy/lsp-php) - 
...
- [mentor](https://github.com/skangas/mentor) - mentor is a GNU Emacs frontend for the rTorrent bittorrent client.
...
- [eredis](https://github.com/justinhj/eredis) - An Emacs client for Redis
...
- [pythonic](https://github.com/pythonic-emacs/pythonic) - Utility functions for writing pythonic emacs package.
...
- [org-ql](https://github.com/alphapapa/org-ql) - An Org-mode query language, search command, and agenda-like view
...
- [ghub](https://github.com/magit/ghub) - Client libraries for the APIs of various Git forges
...
- [ipython-shell-send-el](https://github.com/jackkamm/ipython-shell-send-el) - IPython magic in Emacs
...
- [counsel-etags](https://github.com/redguardtoo/counsel-etags) - Fast, energy-saving, and powerful code navigation solution
...
- [helm-dash](https://github.com/dash-docs-el/helm-dash) - Browse Dash docsets inside emacs
...
- [hasky-mode](https://github.com/hasky-mode/hasky-mode) - *SUSPENDED* A major mode for Haskell which provides syntax highlighting
...
- [ede-php-autoload](https://github.com/emacs-php/ede-php-autoload) - PHP autoloading simulation for Emacs' Semantic
...
- [php-mode](https://github.com/emacs-php/php-mode) - A PHP mode for GNU Emacs
...
- [ruby-test-mode](https://github.com/ruby-test-mode/ruby-test-mode) - Emacs minor mode for Behaviour and Test Driven Development in Ruby
...
- [org-web-tools](https://github.com/alphapapa/org-web-tools) - View, capture, and archive Web pages in Org-mode
...
- [emacs-ereader](https://github.com/bddean/emacs-ereader) - Epub reader for emacs with org-mode integration (not maintained)
...
- [emacs-kaolin-themes](https://github.com/ogdenwebb/emacs-kaolin-themes) - Set of eye pleasing themes for GNU Emacs. Supports both GUI and terminal.
...
- [workgroups2](https://github.com/pashinin/workgroups2) - Workgroups2 - Emacs session manager
...
- [company-anaconda](https://github.com/pythonic-emacs/company-anaconda) - Anaconda backend for company-mode.
...
- [pyenv-mode](https://github.com/pythonic-emacs/pyenv-mode) - Integrate pyenv with python-mode.
- [linum-relative](https://github.com/coldnew/linum-relative) - display relative line number in the left margin in emacs
- [nlinum-relative](https://github.com/xcodebuild/nlinum-relative) - Emacs relative line number besed on nlinum-mode
...
- [polymode](https://github.com/polymode/polymode) - Framework for Multiple Major Modes in Emacs (core library)
...
- [ddskk](https://github.com/skk-dev/ddskk) - Daredevil SKK (Simple Kana to Kanji conversion program)
...
- [magithub](https://github.com/vermiculus/magithub) - **This project is being (mostly) migrated into Forge!** -- Magit-based interfaces to GitHub
...
- [webscrot](https://github.com/adnanh/webscrot) - Render screenshots of given urls on Linux using Xvfb, midori, ratpoison & ImageMagick
...
- [csvquery](https://github.com/erizocosmico/csvquery) - Query CSV files with SQL.
...
- [gql](https://github.com/graphql-editor/gql) - Very simple CLI for many GraphQL schemas in the cloud. Provides autocompletion for GraphQL queries
...
- [rts](https://github.com/galeone/rts) - RTS: request to struct. Generates Go structs from JSON server responses.
- [abc](https://github.com/appbaseio/abc) - Power of appbase.io via CLI, with nifty imports from your favorite data sources
- [go-carpet](https://github.com/msoap/go-carpet) - go-carpet - show test coverage in terminal for Go source files
...
- [external-dns](https://github.com/kubernetes-incubator/external-dns) - Configure external DNS servers (AWS Route53, Google CloudDNS and others) for Kubernetes Ingresses and Services
...
- [yaml2json](https://github.com/bronze1man/yaml2json) - a command line tool convert from yaml to json
...
- [emacs-modified-windows](https://github.com/vigou3/emacs-modified-windows) - Mirror of the GitLab project Emacs Modified for Windows
...
- [pLam](https://github.com/sandrolovnicki/pLam) - An interpreter for learning and exploring pure λ-calculus
...
- [hledger](https://github.com/simonmichael/hledger) - Robust command-line/curses/web plaintext accounting tools, a Haskell rewrite of Ledger.
...
- [husk-scheme](https://github.com/justinethier/husk-scheme) - A full implementation of the Scheme programming language for the Haskell Platform.
...
- [benten](https://github.com/intuit/benten) - Chatbot Development Framework (with Slack integration for Jira and Jenkins)
- [nexus-repository-elpa](https://github.com/sonatype-nexus-community/nexus-repository-elpa) - 
...
- [spring-boot-demo](https://github.com/xkcoding/spring-boot-demo) - spring boot demo 是一个用来深度学习并实战 spring boot 的项目，目前总共包含 63 个集成demo，已经完成 51 个。  该项目已成功集成 actuator(监控)、admin(可视化监控)、logback(日志)、aopLog(通过AOP记录web请求日志)、统一异常处理(json级别和页面级别)、freemarker(模板引擎)、thymeleaf(模板引擎)、Beetl(模板引擎)、Enjoy(模板引擎)、JdbcTemplate(通用JDBC操作数据库)、JPA(强大的ORM框架)、mybatis(强大的ORM框架)、通用Mapper(快速操作Mybatis)、PageHelper(通用的Mybatis分页插件)、mybatis-plus(快速操作Mybatis)、BeetlSQL(强大的ORM框架)、upload(本地文件上传和七牛云文件上传)、redis(缓存)、ehcache(缓存)、email(发送各种类型邮件)、task(基础定时任务)、quartz(动态管理定时任务)、xxl-job(分布式定时任务)、swagger(API接口管理测试)、security(基于RBAC的动态权限认证)、SpringSession(Session共享)、Zookeeper(结合AOP实现分布式锁)、RabbitMQ(消息队列)、Kafka(消息队列)、websocket(服务端推送监控服务器运行信息)、socket.io(聊天室)、ureport2(中国式报表)、打包成war文件、集成 ElasticSearch(基本操作和高级查询)、Async(异步任务)、集成Dubbo(采用官方的starter)、MongoDB(文档数据库)、neo4j(图数据库)、docker(容器化)、JPA多数据源、Mybatis多数据源、代码生成器、GrayLog(日志收集)、JustAuth(第三方登录)、LDAP(增删改查)、动态添加/切换数据源、单机限流(AOP + Guava RateLimiter)、ElasticSearch 7.x(使用官方 Rest High Level Client)。
...
- [configuration-as-code-plugin](https://github.com/jenkinsci/configuration-as-code-plugin) - Jenkins Configuration as Code Plugin
- [mage](https://github.com/magefree/mage) - Magic Another Game Engine
- [yaacc-code](https://github.com/tobexyz/yaacc-code) - 
- [cidrcalculator](https://github.com/rmceoin/cidrcalculator) - CIDR Calculator is a simple Android based IP subnet calculator for network engineers to quickly determine what the address range is of a subnet.
...
- [gitlab-oauth-plugin](https://github.com/jenkinsci/gitlab-oauth-plugin) - jenkins authentication plugin using gitlab oauth as source
...
- [linkgopher](https://github.com/az0/linkgopher) - Firefox add-on: Extracts all links from web page, sorts them, removes duplicates, and displays them in a new tab for inspection or copy and paste into other systems.
- [add-url-to-window-title](https://github.com/erichgoldman/add-url-to-window-title) - A Firefox addon which will put the web page address (URL) into the window's title. Useful for customizing KeePass's auto-type
...
- [multi-keywords-highlighter](https://github.com/ivanruvalcaba/multi-keywords-highlighter) - Highlights given keywords on any web page you visit —Mozilla Firefox Add-on—
...
- [SnapLinksPlus](https://github.com/cpriest/SnapLinksPlus) - Snap Links Plus is a Browser Addon that lets you  lasso links, checkboxes and other  elements do things with them.
...
- [contentful-export](https://github.com/contentful/contentful-export) - This tool allows you to export a Contentful space to a JSON dump
...
- [AutoFullscreen](https://github.com/tazeat/AutoFullscreen) - 
- [ModernKiosk](https://github.com/racketlogger/ModernKiosk) - Kiosk-like WebExtension for Firefox
- [userChrome.js](https://github.com/ardiman/userChrome.js) - Skripte für die Firefox-Erweiterung userChromeJS
...
- [json-2-csv](https://github.com/mrodrig/json-2-csv) - Convert JSON to CSV *or* CSV to JSON!
...
- [pixel-saver](https://github.com/pixel-saver/pixel-saver) - Pixel Saver
...
- [croissant](https://github.com/giann/croissant) - 🥐 A Lua REPL and debugger
...
- [shadows](https://github.com/matiasah/shadows) - Shädows - A Shadows & Lights engine for löve
...
- [mscheme](https://github.com/marcoheisig/mscheme) - A Scheme interpreter in Matlab
...
- [ansible-dotfiles-assh](https://github.com/wrboyce/ansible-dotfiles-assh) - 
...
- [cli-debugging-cheatsheets](https://github.com/trstringer/cli-debugging-cheatsheets) - :fire: Collection of command-line debugging cheatsheets for multiple languages and runtimes
...
- [SteamOS](https://github.com/ValveSoftware/SteamOS) - SteamOS community tracker
...
- [msgphp](https://github.com/msgphp/msgphp) - Reusable domain layers. Shipped with industry standard infrastructure.
...
- [os-autoinst](https://github.com/os-autoinst/os-autoinst) - OS-level test automation
- [gitzone](https://github.com/dyne/gitzone) - git-based zone management tool for static and dynamic domains
...
- [minion](https://github.com/mojolicious/minion) - :octopus: Perl job queue
...
- [dategrep](https://github.com/mdom/dategrep) - print lines matching a time range
...
- [bmo](https://github.com/mozilla-bteam/bmo) - bugzilla.mozilla.org source - report issues here: https://bugzilla.mozilla.org/enter_bug.cgi?product=bugzilla.mozilla.org&format=__default__
...
- [gitlab-dashboard](https://github.com/KSF-Media/gitlab-dashboard) - 📺 TV dashboard for a global view on Gitlab Pipelines
...
- [git-lint](https://github.com/sk-/git-lint) - improving source code one step at a time
...
- [redmine-cli](https://github.com/yanjost/redmine-cli) - Redmine command line client
...
- [gazelle](https://github.com/surrsurus/gazelle) - Gazelle - A scripting language inspired by LISP and Scheme
- [sluggo](https://github.com/felko/sluggo) - Smart shell that can handle mutliple REPLs
- [slacker](https://github.com/netromdk/slacker) - Slacker - Easy access to the Slack API and admin of workspaces/teams.
- [memrepl](https://github.com/agustingianni/memrepl) - Memory inspection REPL interface
- [flask-konch](https://github.com/sloria/flask-konch) - An improved shell command for the Flask CLI
...
- [zbx_template_pack](https://github.com/v-zhuravlev/zbx_template_pack) - Zabbix Templates Pack. For SNMP devices such as network switches, routers, hardware servers. Also for Applications. Created by template generator
...
- [alerta-contrib](https://github.com/alerta/alerta-contrib) - Contributed integrations, plugins and custom webhooks
...
- [tf_audio_steganalysis](https://github.com/Charleswyt/tf_audio_steganalysis) - Audio steganalysis  with tensorflow.
...
- [visbrain](https://github.com/EtienneCmb/visbrain) - A multi-purpose GPU-accelerated open-source suite for brain data visualization
...
- [rofi-files](https://github.com/cjbassi/rofi-files) - Use rofi to search files and directories with fd and open them with xdg-open
...
- [ansible-zabbix-agent](https://github.com/dj-wasabi/ansible-zabbix-agent) - Installing and maintaining zabbix-agent for RedHat/Debian/Ubuntu/Windows/Suse.
- [Zabbix-in-Telegram](https://github.com/ableev/Zabbix-in-Telegram) - Zabbix Notifications with graphs in Telegram
- [zabbix-rss](https://github.com/TurtleResearch/zabbix-rss) - A tiny self-serving RSS wrapper for Zabbix API. Hosts an RSS feed for zabbix trigger events.
...
- [subscope](https://github.com/parkouss/subscope) - A command line tool to download subtitles for your movies
...
- [camomilla](https://github.com/SuperV1234/camomilla) - Simple Python script that simplifies C++ compiler errors. Useful when using heavily-templated libraries.
...
- [notifico](https://github.com/TkTech/notifico) - My personal http://cia.vc replacement project. Now used by over 3000 projects.
...
- [pypi2nix](https://github.com/nix-community/pypi2nix) - Generate Nix expressions for Python packages [maintainer=@seppeljordan]
...
- [dotfiles](https://github.com/Olical/dotfiles) - Configuration for Arch Linux, i3, Kitty, fish, Neovim and more
...
- [pyramid-tinyurl-doodle](https://github.com/offby1/pyramid-tinyurl-doodle) - "Hello, world" for the web.  Live at https://teensy.info
...
- [Cnchi](https://github.com/Antergos/Cnchi) - A modern, flexible online system installer for Antergos Linux
...
- [orchestra](https://github.com/b12io/orchestra) - Orchestra is a Robotic Process Automation system for orchestrating project teams of experts and machines.
...
- [quokka](https://github.com/rochacbruno-archive/quokka) - LOOKING FOR NEW MAINTAINER - Quokka is a Content Management System - `docker run --rm -it -p 5000:5000 quokka/quokka`
...
- [python-fuse](https://github.com/libfuse/python-fuse) - Python 2.x/3.x bindings for libfuse 2.x
...
- [flare-game](https://github.com/flareteam/flare-game) - Fantasy action RPG using the FLARE engine
...
- [vk](https://github.com/voronind/vk) - vk.com API python wrapper
...
- [tower-cli](https://github.com/ansible/tower-cli) - THIS TOOL IS NO LONGER UNDER ACTIVE DEVELOPMENT.  This tool is being phased out in favor of the new official AWX CLI
...
- [pathfindR](https://github.com/egeulgen/pathfindR) - Pathway Enrichment Analysis Utilizing Active Subnetworks
...
- [radiator](https://github.com/thierrygosselin/radiator) - RADseq Data Exploration, Manipulation and Visualization using R
...
- [waxeye](https://github.com/orlandohill/waxeye) - Waxeye is a parser generator based on parsing expression grammars (PEGs). It supports C, Java, JavaScript, Python, Racket, and Ruby.
...
- [ifme](https://github.com/ifmeorg/ifme) - Free and open source app to share mental health experiences with loved ones
...
- [scheme-bytestructures](https://github.com/TaylanUB/scheme-bytestructures) - Structured access to bytevector contents.
...
- [govuk-guix](https://github.com/alphagov/govuk-guix) - Package, service and system definitions using GNU Guix for software and systems related to GOV.UK.
...
- [tmux-cssh](https://github.com/peikk0/tmux-cssh) - ClusterSSH with tmux
...
- [stub.sh](https://github.com/jimeh/stub.sh) - Helpers for bash script testing to stub/fake binaries and functions. Includes support for validating number of stub calls, and/or if stub has been called with specific arguments.
...
- [pia-tools](https://github.com/pschmitt/pia-tools) - Shell script to automate privateinternetaccess port forwarding and starting/stopping transmission when connected/disconnected and other stuff
...
- [tiny-tutorials](https://github.com/starkandwayne/tiny-tutorials) - Quick tutorials on quick things that make each devops day better
- [ops](https://github.com/feiskyer/ops) - Tools&scripts for daily devops.
...
- [debs](https://github.com/zabbix-deb/debs) - Debian package for Zabbix Server Client and Proxy
...
- [nix-install-vendor-gl](https://github.com/deepfire/nix-install-vendor-gl) - Ensure that a system-compatible OpenGL driver is available for `nix-shell`-encapsulated programs.
...
- [URLextractor](https://github.com/eschultze/URLextractor) - Information gathering & website reconnaissance | https://phishstats.info/
...
- [latex-homework-template](https://github.com/jdavis/latex-homework-template) - 🎓📄 The LaTeX file that I used as the base for all my homework in university.
...
- [SOSML](https://github.com/SOSML/SOSML) - An interpreter for Standard ML written in TypeScript.
...
- [hastic-grafana-app](https://github.com/hastic/hastic-grafana-app) - Visualization panel and datasource for Grafana with UI for labeling and rendering patterns
...
- [CintoDeUtilidadesDocker](https://github.com/msfidelis/CintoDeUtilidadesDocker) - My Docker templates repository :whale: :cloud: :whale:
...
- [Fragments](https://github.com/haecker-felix/Fragments) - Moved to GNOME GitLab -&gt; https://gitlab.gnome.org/haecker-felix/Fragments
